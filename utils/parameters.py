...
def siScore_parser():
    ...
    parser.add_argument('--batch-sz', default=32, type=int, help='batch size') #16
    ...
    parser.add_argument('--dir_name', type=str, default='cluster_sichuan', help='directory name for cluster data')
    parser.add_argument('--cluster_num', default=22, type=int, help='number of clusters')
    parser.add_argument('--model', type=str, help='Model name') 
    parser.add_argument('--graph_config', default='sichuan.txt', type=str, help='graph config path')
    parser.add_argument('--name', type=str, default='sichuan', help='model & annotated directory name')
    parser.add_argument('--img', type=str, default='sichuan_granules', help='name of the image directory')   
    return parser.parse_args()
